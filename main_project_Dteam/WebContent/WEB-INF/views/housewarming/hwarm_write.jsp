...
<!-- 상단 마진 부여 -->
<form name="insertHwarm" action="insertHwarm" method="post" enctype="multipart/form-data">
	<!-- form 영역 시작 -->
	...
	<div class="editor-section">
		<div class="container container-sm">
			<div class="hwrite_collapse_header">
				<a class="hwrite_collapse_btn" data-bs-toggle="collapse"
					href="#hwrite_collapse" role="button" aria-expanded="false"
					aria-controls="hwrite_collapse"> &#9999; 필수정보 입력 </a>
			</div>
			<div class="collapse" id="hwrite_collapse">
				<!-- collapse 시작 -->
				<!-- 설문 1: 주거형태 -->
					...
					<div class="editor-form-group__content">
						<div class="custom-radios">
							...
							<div>
								...
								<label for="color-2"> <span
									style="background-color: #ffd3b6"> <img
										src="https://s3-us-west-2.amazonaws.com/s.cdpn.io/242518/check-icn.svg"
										alt="Checked Icon" />
								</span>
								</label>
							...
							<div>
								...
								<label for="color-3"> <span
									style="background-color: #e0a899"> <img
										src="https://s3-us-west-2.amazonaws.com/s.cdpn.io/242518/check-icn.svg"
										alt="Checked Icon" />
								</span>
								</label>
							...
							<div>
								...
								<label for="color-4"> <span
									style="background-color: #604439"> <img
										src="https://s3-us-west-2.amazonaws.com/s.cdpn.io/242518/check-icn.svg"
										alt="Checked Icon" />
								</span>
								</label>
							...
							<div>
								...
								<label for="color-5"> <span
									style="background-color: #e74c3c"> <img
										src="https://s3-us-west-2.amazonaws.com/s.cdpn.io/242518/check-icn.svg"
										alt="Checked Icon" />
								</span>
								</label>
							...
							<div>
								...
								<label for="color-6"> <span
									style="background-color: #f0c75e"> <img
										src="https://s3-us-west-2.amazonaws.com/s.cdpn.io/242518/check-icn.svg"
										alt="Checked Icon" />
								</span>
								</label>
							...
							<div>
								...
								<label for="color-7"> <span
									style="background-color: #a0d6b4"> <img
										src="https://s3-us-west-2.amazonaws.com/s.cdpn.io/242518/check-icn.svg"
										alt="Checked Icon" />
								</span>
								</label>
							...
							<div>
								...
								<label for="color-8"> <span
									style="background-color: #4b86b4"> <img
										src="https://s3-us-west-2.amazonaws.com/s.cdpn.io/242518/check-icn.svg"
										alt="Checked Icon" />
								</span>
								</label>
							...
							<div>
								...
								<label for="color-9"> <span
									style="background-color: #505050"> <img
										src="https://s3-us-west-2.amazonaws.com/s.cdpn.io/242518/check-icn.svg"
										alt="Checked Icon" />
								</span>
								</label>
							...
							<div>
								...
								<label for="color-10"> <span
									style="background-color: #000000"> <img
										src="https://s3-us-west-2.amazonaws.com/s.cdpn.io/242518/check-icn.svg"
										alt="Checked Icon" />
								</span>
								</label>
	...
	<!-- editor-top-section 끝 -->


	<!-- 집들이 내용 입력 -->
	<div class="hwarm-content">
		<!-- hwarm-content 시작 -->
		<div class="editor-section row">
			<!-- 이미지 업로드 부분 -->
			<div class="image-container col-md-6">
				<!-- 이미지 -->
				<img style="width: 95%;" class="preview-image"
					src="resources/assets/img/housewarming/file_dummy.png">
				<!-- 파일 업로드 버튼 -->
				...
				<!-- 관련 제품 태그 버튼 -->
				<a class="tag-btn upload-file-btn-span"	style="background-color: #ff6f69;" target="_blank"> 
			...
			<!-- 내용 입력 부분 -->
			<div class="col-md-6">
				<textarea class="hwd_content_list" name="hwd_content_list" rows="18"
					cols="42" placeholder="어떤 공간인가요? 사진에 대한 이야기를 해주세요."></textarea>
	...
	<div class="editor-section row hwarm_title">
		<a href="javascript:appendHwamContent()" class="hwrite_collapse_btn"><i
			class="fas fa-plus"></i> 내용 추가하기</a>
	</div>
...
// DOM이 생성되면 내용 박스 부분의 코드를 읽어옴
var html = '';
$(document).ready(function () {
	html = $('.hwarm-content').html();
});

// 위에서 읽어온 html을 바탕으로 추가하기 버튼을 누르면 내용 박스를 추가하는 코드
...
$(document).on("click", ".tag-btn", function() {
	var hwarm = $(this).parent().parent().parent();
    var popup = window.open('popupImage', '제품 태그 팝업', 'width=1200px,height=750px,scrollbars=yes');
    var order = parseInt($('.tag-btn').index((this)));
    console.log(order);
