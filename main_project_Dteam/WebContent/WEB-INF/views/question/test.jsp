	...
	<div id="page">
				...
				<div class="section">
					<ul>
						<li><a href="product.html"><img
								src="resources/detail/images/d1.jpg" alt="thumbnail"></a></li>
						<li><a href="product.html"><img
								src="resources/detail/images/d3.jpg" alt="thumbnail"></a></li>
						<li><a href="product.html"><img
								src="resources/detail/images/d1.jpg" alt="thumbnail"></a></li>
						<li><a href="product.html"><img
								src="resources/detail/images/d3.jpg" alt="thumbnail"></a></li>
					...
					<div>
						<img src="resources/detail/images/d2.jpg" alt="view">
					</div>
				</div>
				<div class="section">
					<p>
		...
		<div id="product">
            ...
            <div class="footer">
				<ul class="items">
					<li><a href="product.html"> <img
							src="resources/detail/images/s.jpg" alt="Img"> <span><del>81,100원</del>&nbsp;
