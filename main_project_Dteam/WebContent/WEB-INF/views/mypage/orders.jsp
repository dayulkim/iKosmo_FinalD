					...
					<div class="d-md-flex align-items-center">
						<div
							...
							<img class="rounded-circle"
								src="resources/uploadFile/profile/${memvo.mem_profile}"
								alt="${memvo.mem_id}">
						</div>
						<div class="ps-md-3">
					...
					<div class="accordion-item">
						<h2 class="accordion-header" id="headingOne${i.index }">
							<button class="accordion-button" type="button"
								...
								aria-expanded="true" aria-controls="collapseOne${i.index }">구매내역 #
								${purvo.pur_date }</button>
						</h2>
								...
								<div
									...
									<div
										...
										<a class="d-block flex-shrink-0 mx-auto me-sm-4"
											...
											src="${ordvo.productVO.pro_thumb }" alt="Product"></a>
										<div class="pt-2">
											<h3 class="product-title fs-base mb-2">
												<a href="shop-single-v1.html"></a>
											</h3>
											<div class="fs-sm">
												<span class="text-muted me-2 commaPrice">가격:
													${ordvo.productVO.pro_dprice }원</span>
											</div>
											<div class="fs-sm">
												<span class="text-muted me-2">수량: ${ordvo.ord_qty }개</span>
											</div>
									...
									<div class="pt-2 ps-sm-3 mx-auto mx-sm-0 text-center">
										...
										<button class="review-btn btn btn-outline-warning btn-sm" type="button"
											 value="${ordvo.productVO.pro_num }">
											<i class="far fa-edit"></i>&nbsp;&nbsp;리뷰쓰기
										</button>
