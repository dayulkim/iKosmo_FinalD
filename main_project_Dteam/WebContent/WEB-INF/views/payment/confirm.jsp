         ...
         <aside class="col-lg-4 pt-4 pt-lg-0 ps-xl-5">
            <div class="bg-white rounded-3 shadow-lg p-4 ms-lg-auto">
               <div class="py-2 px-xl-2">
                  ...
                  <h3 class="fw-normal text-center my-4 commaPrice">${totalPrice + 2500}원</h3>
                  <!-- 단일 상품 즉시 구매인 경우 상품번호와 주문수량을 넘겨주기 -->
                  <input type="hidden" id="pro_num" name="pro_num" value="${pro_num}">
                  <input type="hidden" id="ord_qty" name="ord_qty" value="${ord_qty}"> 
                  <!-- 즉시구매인지, 장바구니를 통한 구매인지 구분할 수 있는 파라미터 넘겨주기 -->
